...
async function main() {
    ...
    const Pumpkin = await _Pumpkin.deploy(_sender.address,[WETH.address,AAVE.address ],[50,50],"pumpkins", "HWEEN");
    ...
    console.log("Swapping underlying tokens on SpookySwap...")
    console.log("done...")
    ...
    const AAVEPumpkinBalance2 = await AAVE.connect(aaveWhale).balanceOf(Pumpkin.address);
    const wethPumpkinBalance2 = await WETH.connect(wethWhale).balanceOf(Pumpkin.address);

    console.log("Pumpkin AAVE Balance after Rebalance: ", AAVEPumpkinBalance2.toString());
    console.log("Pumpkin WETH Balance after Rebalance: ", wethPumpkinBalance2.toString());
